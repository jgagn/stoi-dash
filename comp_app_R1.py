...
athlete_layout = html.Div([
    ...
    dcc.Dropdown(
        ...
        options=[
            {'label': 'D', 'value': 'D'},
            {'label': 'E', 'value': 'E'},
            {'label': 'Summary', 'value': 'Summary'}  # Remove 'Score' option and add 'Summary' option
        ],
...
def update_graph(selected_athlete, selected_results, y_axis):
    ...
    if y_axis == 'Summary':
        ...
        for result in selected_results:
            ...
            trace_d = go.Bar(x=[result], y=d_values, name='D Score')
            trace_e = go.Bar(x=[result], y=e_values, name='E Score')
        ...
        for result in selected_results:
            ...
            trace = go.Bar(x=[result], y=y_values, name=result)
            data.append(trace)
